...
irap_wrapper.sh kallisto kallisto quant $(kallisto_quant_params) -i $(kallisto_index_name) $(if $(4),-l $(3),--single -l $(if $(kallisto_se_fragment_length),$(kallisto_se_fragment_length),$($(1)_rs)) -s $(kallisto_se_sd)) $(call kallisto_strand_params,$(5))  -t $(kallisto_threads) -o $(1)  $(2)
endef
# 
