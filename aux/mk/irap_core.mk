...
# If we're on 'auto', then the transcriptome can be produced using
# irap_gtf_to_fasta (both with and without spikes). If we're not auto, then
# spikes have to be 'cat'd. The last situation- user has supplied a GTF but no
# spikes required- means we don't have to do anything.
