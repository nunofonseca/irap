...
while (my $inseq = $seq_in->next_seq) {
    ...
    print "$id\tspikein\texon\t1\t$len\t.\t+\t.\tgene_id \"$id\"; transcript_id \"$id\"; exon_number \"1\"; gene_name \"$id\"; exon_id \"e${id}_1\"; transcript_biotype \"protein_coding\"; gene_biotype \"protein_coding\"; gene_type \"protein_coding\";\n";
